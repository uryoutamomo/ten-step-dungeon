...
const out=path.join(root,pages?'docs':'release');
...
const siteUrl='https://uryoutamomo.github.io/ten-step-dungeon/';
const social=pages?`<link rel="canonical" href="${siteUrl}"><meta property="og:type" content="website"><meta property="og:locale" content="ja_JP"><meta property="og:url" content="${siteUrl}"><meta property="og:title" content="10歩ダンジョン"><meta property="og:description" content="帰るまでが、冒険だ。足跡とスライムと伝説の剣、一人用の小さな冒険。"><meta property="og:image" content="${siteUrl}og.png"><meta name="twitter:card" content="summary_large_image"><meta name="twitter:title" content="10歩ダンジョン"><meta name="twitter:description" content="帰るまでが、冒険だ。"><meta name="twitter:image" content="${siteUrl}og.png">`:'';
const html='<!doctype html><html lang="ja"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta name="color-scheme" content="light"><title>10歩ダンジョン — 帰るまでが、冒険だ。</title><meta name="description" content="足跡、スライム、伝説の剣。一人用の小さな冒険。">'+social+'<style>'+css+'</style></head><body><div id="root"></div><script>'+js+'</script></body></html>';
if(pages){
 await writeFile(path.join(out,'index.html'),html);
 await copyFile(path.join(root,'public/og.png'),path.join(out,'og.png'));
 await writeFile(path.join(out,'.nojekyll'),'');
 console.log(`GitHub Pages exported: ${path.join(out,'index.html')} (${Math.round(Buffer.byteLength(html)/1024)} KB)`);
}else{
